...
const deletePharmacy = async (req, res) => {
    try {
        ...
        let pharma_id = pharmacy.map((item) => { return item.id })
...
const updatePharmacy = async (req, res) => {
    try {
        ...
        const cateExists = await pharmacyService.getPharmacyById(pharmacyId);
        if (!cateExists) {
...
module.exports = { createPharmacy, getPharmacy, deletePharmacy, updatePharmacy };
